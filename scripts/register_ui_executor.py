...
import_block = '        from microgravity.agent.tools.ui_planner import UIUXPlannerTool'
new_import = import_block + '\n        from microgravity.agent.tools.ui_executor import UIAgentExecutorTool'

if import_block in content and 'from microgravity.agent.tools.ui_executor' not in content:
