...
import_block = '        from microgravity.agent.tools.ui_executor import UIAgentExecutorTool'
new_import = import_block + '\n        from microgravity.agent.tools.desktop import DesktopVisionTool'

if import_block in content and 'from microgravity.agent.tools.desktop' not in content:
