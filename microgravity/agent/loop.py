...
from microgravity.agent.tools.cron import CronTool
from microgravity.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from microgravity.agent.tools.message import MessageTool
from microgravity.agent.tools.registry import ToolRegistry
from microgravity.agent.tools.shell import ExecTool
from microgravity.agent.tools.spawn import SpawnTool
from microgravity.agent.tools.web import WebFetchTool, WebSearchTool
from microgravity.agent.tools.browser import BrowserTool
from microgravity.agent.tools.swarm import SwarmStatusTool
from microgravity.agent.tools.tasks import TaskTrackerTool
from microgravity.agent.tools.profile import UserProfileTool
from microgravity.agent.tools.memory_tools import SearchHistoryTool, UpdateMemoryTool, ReadMemoryTool, SemanticSearchTool
from microgravity.agent.tools.capability import AnalyzeCapabilityExpansionTool
from microgravity.bus.events import InboundMessage, OutboundMessage
from microgravity.bus.queue import MessageBus
from microgravity.providers.base import LLMProvider
from microgravity.session.manager import Session, SessionManager
from microgravity.agent.introspection import IntrospectionManager
from microgravity.agent.failure import FailureHandler

if TYPE_CHECKING:
    from microgravity.config.schema import ExecToolConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        self.brave_api_key = brave_api_key or load_config().tools.web.search.api_key
    ...
    def _register_default_tools(self) -> None:
        ...
        from microgravity.agent.tools.environment import ReadEnvVarTool, SetEnvVarTool
        self.tools.register(ReadEnvVarTool())
        self.tools.register(SetEnvVarTool())
        from microgravity.agent.tools.path_memory import BookmarkPathTool, RecallPathsTool
        from microgravity.agent.tools.code_analyzer import OutlineCodeTool, AnnotateCodeTool
        from microgravity.agent.tools.diagnostics import ReadLogsTool
        ...
        from microgravity.agent.tools.credentials import SearchCredentialTool, StoreCredentialTool, InvalidateCredentialTool
        from microgravity.agent.tools.evolution import LogIssueTool, LogUserFeedbackTool, ViewEvolutionReportTool
    ...
    async def _connect_mcp(self) -> None:
        ...
        from microgravity.agent.tools.mcp import connect_mcp_servers
        try:
