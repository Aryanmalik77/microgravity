...
from microgravity.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from microgravity.agent.tools.shell import ExecTool
from microgravity.agent.tools.web import WebSearchTool, WebFetchTool
...
class SubagentManager:
    ...
    async def _run_subagent(
        ...
        try:
            from microgravity.agent.tools.diagnostics import ReadLogsTool
            from microgravity.agent.tools.ui_executor import UIAgentExecutorTool
