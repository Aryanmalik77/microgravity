...
from microgravity.agent.tools.base import Tool


def _run_backend(workspace: Path, args: list[str]) -> str:
    """Helper to execute the credential_search.py backend script."""
    # Resolve the script relative to this current file (__file__ is in microgravity/agent/tools/)
    # parent 1: tools, parent 2: agent, parent 3: microgravity (inner)
    ...
    if not script_path.exists():
        ...
        script_path = workspace / "microgravity" / "scripts" / "credential_search.py"
