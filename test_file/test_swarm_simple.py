...
def test_step1_core_engine():
    ...
    # 1a. FSM
    from microgravity.swarm.fsm import AgentFSM, AgentState
    ...
    # 1b. DuckDB Ledger
    from microgravity.swarm.state.duckdb_ledger import DuckDBLedger
    td = tempfile.mkdtemp()
    ...
    # 1c. Memory Adapter
    from microgravity.swarm.memory.adapter import MemoryAdapter
    mem = MemoryAdapter()
    ...
    from microgravity.swarm.concept_standardizer import ConceptStandardizer
    ...
    from microgravity.swarm.experiential_learning import ExperientialLearningModule
    ...
    from microgravity.swarm.knowledge_indexer import KnowledgeIndexer
    ...
    # 1g. Event Bus
    from microgravity.swarm.event_bus import DurableEventBus
...
def test_step2_pipeline():
    ...
    # 2a. Validators
    from microgravity.swarm.pipeline.validators import PipelineValidator
    ...
    from microgravity.swarm.pipeline.hypothesis_engine import HypothesisEngine
    ...
    from microgravity.swarm.pipeline.analytical_scripts import AnalyticalScripts
...
def test_step3_vector_routing():
    ...
    from microgravity.swarm.vector_store.mental_association import MentalAssociationFaculty, VectorMath
...
def test_step4_agents():
    ...
    from microgravity.swarm.agents.base_seeker import BaseSeekerAgent
    logger.info("  ✅ BaseSeekerAgent imported")
    
    from microgravity.swarm.agents.necessity_sensor import NecessitySensor, ResourceBlueprintSchema
    ...
    from microgravity.swarm.agents.insight_internalizer import InsightInternalizer, InternalizationSchema
    ...
    from microgravity.swarm.agents.process_analyzer import ProcessAnalyzer, ProcessAuditSchema
    ...
    from microgravity.swarm.agents.strategy_grader import StrategyGrader, StrategyGradingSchema
    ...
    from microgravity.swarm.agents.optimization_seeker import OptimizationSeeker, OptimizationPlanSchema
    ...
    from microgravity.swarm.agents.action_seeker import ActionSeeker, ActionCommandSchema
    ...
    from microgravity.swarm.agents.coding_seeker import CodingSeeker, CodingSchema
    agents["CodingSeeker"] = CodingSchema
    logger.info(f"  ✅ CodingSeeker -> Schema fields: {list(CodingSchema.model_fields.keys())}")
    
    from microgravity.swarm.agents.architecture_estimator import ArchitectureEstimator, ArchitectureSchema
...
def test_step5_operator_integration():
    ...
    from microgravity.swarm.broker.lmdb_broker import LMDBBroker
    from microgravity.swarm.state.duckdb_ledger import DuckDBLedger
    from microgravity.swarm.operator import SeekingOperator
