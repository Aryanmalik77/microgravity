...
def execute_chrome_task():
    ...
    actions = [
        ...
        {"action": "wait", "duration": 5.0}, # Wait for Chrome
        {"action": "press", "key": "ctrl+l"}, # Focus address bar
        {"action": "wait", "duration": 1.0},
        {"action": "press", "key": "backspace"}, # Clear any debris
        {"action": "wait", "duration": 0.5},
        {"action": "type", "text": "https://web.whatsapp.com"},
        {"action": "wait", "duration": 1.0},
        {"action": "press", "key": "enter"},
        {"action": "wait", "duration": 12.0}, # Wait for WhatsApp load
        {"action": "press", "key": "ctrl+d"}, # Bookmark
        {"action": "wait", "duration": 2.0},
        {"action": "press", "key": "enter"}, # Confirm bookmark
